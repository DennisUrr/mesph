...
def main(total_cpus, output_dir, path_outputs_fargo, total_timesteps, Ntot, alpha, beta, total_files):
    dT=str(0)
...
if __name__ == '__main__':
    ...
    main(total_cpus, output_dir, path_outputs_fargo, total_timesteps, Ntot, alpha, beta, total_files)
